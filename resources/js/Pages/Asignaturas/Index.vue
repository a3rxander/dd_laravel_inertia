                    ...
                    <div class="md:col-span-2 mt-5 md:mt-0">
                        <div class="shadow bg-white md:rounded-md p-4"> 
                            <div class="flex justify-between">
                                ...
                                <inertia-link :href="route('asignaturas.create')" class="bg-blue-500 text-white font-bold py-2 px-4 rounded-md">
                                    Crear
                                </inertia-link>
                            </div>
                            <hr class="my-6">
                            <table>
                                <tr v-for="asignatura in asignaturas" :key="asignatura.id" >
                                    ...
                                    <td class="px-4 py-2">
                                        <inertia-link :href="route('asignaturas.show', asignatura.id)">
                                            Ver
                                        </inertia-link>
                                    </td>
                                    <td class="px-4 py-2">
                                        <inertia-link :href="route('asignaturas.edit', asignatura.id)">
                                            Editar
                                        </inertia-link>
                                    </td>
                                </tr>
...
<script>
    ...
    export default {
        ...
        watch: {
            q: function (value) {
                this.$inertia.replace(this.route('asignaturas.index', {q: value}))
            }
        }
    }
</script>
